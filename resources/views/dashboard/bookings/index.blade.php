...
<div class="lg:ml-50 px-6 py-8 text-left" style="direction:ltr">
    ...
    {{-- Filters Bar --}}
    <div class="flex flex-wrap items-center gap-3 w-full justify-center mb-8">

        {{-- Status Filter --}}
        <form method="GET">
            <select name="status"
                    onchange="this.form.submit()"
                    class="border rounded-xl px-3 py-2 text-sm bg-white shadow-sm hover:border-gray-400 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <div class="bg-white border rounded-2xl shadow-sm p-5 hover:shadow-md transition">
            ...
            <div class="mt-5 flex flex-wrap gap-2">
                ...
                @if(
                    ...
                    (auth()->user()->hasRole('admin') || $booking->employee_id == auth()->id())
                )
        ...
        @empty
        <p class="text-gray-500 text-sm">No bookings found for this filter.</p>
        @endforelse
